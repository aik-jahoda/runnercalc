...
let messages = [
    ...
    { id: 47, type: MessageType.negative, text: "Slabší zdraví, ale celkem normálně plynoucí život. Nositel tohoto čísla ve vzorci by se měl vyvarovat vzteklosti z bezmoci." },
    { id: 48, type: MessageType.negative, text: "Více nepřátel než přátel, člověku s tímto číslem ve vzorci osudu budou házeny klacky pod nohy. Chce to najít rovnováhu v meditaci či umění." },
    ...
    { id: 50, type: MessageType.positive, text: "Nápaditost, flexibilita, člověk se řídí heslem, že nic není nemožné, vše jde nějak zařídit. Velmi dobré číslo pro současnou dobu." },
    ...
    { id: 52, type: MessageType.negative, text: "Konflikty, nestálost, někdy až zlo. S tímto číslem je zapotřebí se velmi ovládat. Nelehké partnerské vztahy." },
    { id: 53, type: MessageType.positive, text: "Číslo, které přináší spokojenost, žádné velké problémy, nenáročnost. Velmi snášenlivé a harmonické se vztahem k umění a cestování." },
    { id: 54, type: MessageType.negative, text: "Opatrnost. Člověk s tímto číslem ve vzorci jména by neměl slibovat nic,  co nemůže splnit. Obtíže, nespokojenost." },
    { id: 55, type: MessageType.negative, text: "S tímto číslem ve vzorci může mít člověk pocit, jako by byl jednou nahoře a podruhé dole. To může vést ke zlosti a zklamání. Začíná často několikrát v životě." },
    { id: 56, type: MessageType.negative, text: "Problematické osobní vztahy, někdy podezíravost či hádavost, nedůvěra v druhé lidi." },
    ...
    { id: 59, type: MessageType.positive, text: "Časté cesty do zahraničí, dobré kontakty s lidmi, smlouvy a jednání. Nezapomínat ale na opatrnost." },
    { id: 60, type: MessageType.negative, text: "Ztížený soukromý život, povinnosti, pocit okovů a vězení. Jako by byl člověk v kleci, neví, co by měl udělat. Připadá mu, že každý jeho krok je zbytečný a bezvýznamný." },
    ...
    { id: 62, type: MessageType.positive, text: "Dobrý citový život, rodinné zázemí. Spokojenost a láska." },
    { id: 63, type: MessageType.positive, text: "Klidné a harmonické číslo, většinou úspěšné." },
    ...
    { id: 69, type: MessageType.positive, text: "Číslo plné vášně a citu. Celkem úspěšné." },
    ...
    { id: 76, type: MessageType.negative, text: "Stejné jako u čísla 67. Nebezpečí rozvodů, nespokojenost v osobních vztazích, ale i se sebou samým. Pozor na nehody." },
    ...
    { id: 79, type: MessageType.negative, text: "Problémové a ztrátové číslo. Hrozí náhlé nehody, komplikace, ztráty." },
    ...
    { id: 84, type: MessageType.positive, text: "Číslo pro obchodování a úspěšná jednání ve všech sférách." },
    ...
    { id: 95, type: MessageType.positive, text: "Stejné jako u čísla 59. Časté cesty do zahraničí, dobré kontakty s lidmi, smlouvy a jednání. Nezapomínat ale na opatrnost." },
